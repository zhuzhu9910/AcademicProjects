...
namespace XmlProcessing
{
  ...
  public:
    ...
    virtual void addChild(XmlNode* pXmlNode);
    virtual bool removeChild(XmlNode* pXmlNode);
    virtual size_t numChildren();
    virtual std::vector<XmlNode*>& getChildren();
    virtual XmlNode* nextUnmarkedChild();
  ...
  protected:
    ...
    static std::vector<XmlNode*> emptyChildren;
    static std::vector<attributeItem> emptyAttributes;
  };

  //----< make copy of self >----------------------------------------------

  inline XmlNode* XmlNode::clone() { return new XmlNode(*this); }
  ...
  inline void XmlNode::addChild(XmlNode* pXmlNode) {}

  //----< remove child node is empty operation >---------------------------

  inline bool XmlNode::removeChild(XmlNode* pXmlNode) { return false; }
  ...
  inline std::vector<XmlNode*>& XmlNode::getChildren() { return emptyChildren; }

  //----< get next unmarked child is empty operation >---------------------

  inline XmlNode* XmlNode::nextUnmarkedChild() { return 0; }
  ...
  inline XmlNode* XmlTextNode::clone() { return new XmlTextNode(*this); }
  ...
  inline XmlNode* XmlCommentNode::clone() { return new XmlCommentNode(*this); }
  ...
  inline XmlNode* XmlProcInstrNode::clone() { return new XmlProcInstrNode(*this); }
  ...
  inline std::vector<XmlNode*>& XmlElementNode::getChildren() { return children; }
}
#endif
