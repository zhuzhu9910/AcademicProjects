...
*/
  ...
  class Parser ;
  class IBuilder {
  public : virtual ~ IBuilder ( ) {

 LoggingProccessing::FunctionInspector FunIsp("In Class IBuilder :   virtual ~ IBuilder ( ) ");
  }
 ...
 LoggingProccessing::FunctionInspector FunIsp("In Class IAction :   virtual ~ IAction ( ) ");
  }
  ...
  class IRule {
  public : virtual ~ IRule ( ) {

 LoggingProccessing::FunctionInspector FunIsp("In Class IRule :   virtual ~ IRule ( ) ");
  }
  void addAction ( IAction * pAction ) ;
  void doActions ( ITokCollection * pTc ) ;
  virtual bool doTest ( ITokCollection * pTc ) = 0 ;
  protected : std :: vector < IAction *> actions ;
  }
  ;
  ///////////////////////////////////////////////////////////////
  ...
  class Parser {
  public : Parser ( ITokCollection * pTokCollection ) ;
  ~ Parser ( ) ;
  void addRule ( IRule * pRule ) ;
  bool parse ( ) ;
  bool next ( ) ;
  private : ITokCollection * pTokColl ;
  std :: vector < IRule *> rules ;
  }
  ;
  inline Parser :: Parser ( ITokCollection * pTokCollection ) : pTokColl ( pTokCollection ) {

 LoggingProccessing::FunctionInspector FunIsp("  inline Parser :: Parser ( ITokCollection * pTokCollection ) : pTokColl ( pTokCollection ) ");
  }
  inline Parser ::~ Parser ( ) {

 LoggingProccessing::FunctionInspector FunIsp("  inline Parser ::~ Parser ( ) ");
  }
  inline bool Parser :: next ( ) {

 LoggingProccessing::FunctionInspector FunIsp("  inline bool Parser :: next ( ) ");
  return pTokColl -> get ( ) ;
  }
  # endif
